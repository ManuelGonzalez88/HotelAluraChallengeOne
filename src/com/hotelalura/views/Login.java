...
public class Login extends JFrame {
		...
		btnexit.addMouseListener(new MouseAdapter() {
			@Override
				public void mouseClicked(MouseEvent e) {
					if (JOptionPane.showConfirmDialog(null, "¿Desea volver al menú principal?") == 0) {
	...
	private void login() {
		...
		for(int i = 0; i < usuarios.size(); i++) {
			...
			if (txtUsuario.getText().equals(usuarios.get(i).getNombre()) && 
					contraseñaIngresada.equals(usuarios.get(i).getContraseña())) {
